let accept_agreement = async function accept_agreement(database_connection, post_id, student_signature) {
    ...
    //SEND VIA WEBSOCKET!!!!!!
    let notification_response_tutor = await database_connection.create_notification("Agreement accepted",update_post_agremeent_url_response.std_name + " has accepted your agreement for'" + update_post_agremeent_url_response.post_title + "\nTutorial is scheduled:\nDate: " + update_post_agreement_status_response.tutorial_date + "\nDuration: " + update_post_agreement_status_response.tutorial_time + "\nRoom No: " + update_post_agreement_status_response.tutorial_room, update_post_agreement_status_response.post_tutor_email, ["Tutorial agreement accepted"], { post_id: post_id }, update_post_agreement_status_response.std_avatar);
    let notification_response_student = await database_connection.create_notification("Agreement accepted", "You have accepted the agreement from tutor '" + update_post_agremeent_url_response.post_tutor_name + "'.\nTutorial is scheduled:\nDate: " + update_post_agreement_status_response.tutorial_date + "\nDuration: " + update_post_agreement_status_response.tutorial_time + "\nRoom No: " + update_post_agreement_status_response.tutorial_room, update_post_agreement_status_response.std_email, ["Tutorial agreement accepted"], { post_id: post_id }, update_post_agreement_status_response.std_avatar);
