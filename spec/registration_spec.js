...
describe('Register a new user', function () {
    it('should return a success message once user created and updated after digital certificate creation', async function (done) {
        ...
        let test_1_result = await registration.create_new_user("12345aA@", "12345aA@", "D00192082@student.dkit.ie", "0899854571");
    ...
    it('should return an error message that the current email is in use', async function (done) {
        let test_2_result = await registration.create_new_user("12345aA@", "12345aA@", "D00192082@student.dkit.ie", "0899854571");
...
describe('Filter registration input', function () {
    it('should return an error message when the email is not a proper email', function () {
        let test_4_result = filter_registration_input.validate_registration_input("12345aA@", "12345aA@", "a@a.a", "0899854571"); 
    ...
    it('should return an error message when the password does not meet the strength criteria', function () {
        let test_5_result = filter_registration_input.validate_registration_input("12345aA", "12345aA", "nikito888@gmail.com", "0899854571"); 
    ...
    it('should return an error message when the "Password" and "Confirm Password" do not match', function () {
        let test_6_result = filter_registration_input.validate_registration_input("12345aA@", "12345aA", "nikito888@gmail.com", "0899854571"); 
    ...
    it('should return an error message as the entered phone number is not a valid Irish phone number', function () {
        let test_7_result = filter_registration_input.validate_registration_input("12345aA@", "12345aA@", "nikito888@gmail.com", "089985457"); 
    ...
    it('should return an error message as all fields must be filled in to proceed', function () {
        let test_8_result = filter_registration_input.validate_registration_input("", "12345aA", "nikito888@gmail.com", "089985457"); 
